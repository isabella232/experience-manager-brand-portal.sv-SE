...
AEM kan konfigurera **Resurshantering** från den AEM författarinstansen. Administratören aktiverar konfigurationen av resurskällans funktionsflagga från **AEM Web Console Configuration** och överför listan över aktiva Brand Portal-användare i **AEM Assets**.
...
1. Logga in på AEM författarinstans och öppna Configuration Manager
...
1. Navigera från **panelen Verktyg** till **[!UICONTROL Assets > Brand Portal Users]**
...
Mer information finns i [Konfigurera avgiftsmapp](brand-portal-contribution-folder.md).
